...
const Footer = () => {
  return (
    <footer className="bg-black text-white p-8 ">
      <div className="container  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-8 ">
        {/* Contact Information */}
        <div className="tracking-widest">
          ...
          <p className="mt-1 text-white">supportyourteam@gmail.com</p>
